...
class Simulation(object):
    def start_simulation(self, max_correction_step, plane):
        while True:
            ...
            corrected_orientation = current_orientation
            while corrected_orientation != 180:
                print ("Current orientation {0}: ".format(corrected_orientation))
                corrected_orientation = plane.correct_orientation(corrected_orientation, max_correction_step)
